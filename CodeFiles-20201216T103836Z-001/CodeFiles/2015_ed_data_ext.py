...
for i in range(0,len(data)):
    ...
    death_in_ed = int(data[i][549])
    icu_data = int(data[i][557:559])
    hospital_discharge_status = int(data[i][624:626])
    arrival_ambulance = int(data[i][34:36])
    #length_of_visit = int(data[i][565:566])
    obs_unit_discharge = int(data[i][555]) 
...
df_final.to_csv('data_2015_reasons.csv')
