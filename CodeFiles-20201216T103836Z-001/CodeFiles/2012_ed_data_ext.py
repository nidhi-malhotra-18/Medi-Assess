...
df_final = pd.DataFrame(data_final, columns = ['Age','Sex','Temperature','Heart Rate','Resp Rate' ,
    'Systolic BP','Diastolic BP','Pulse Oximetry','Oxygen','Pain','Arrival','Result','Reason1','Reason2','Reason3','esi'])

df_final.to_csv('data_2012_reasons.csv')
