...
for i in range(0,len(data)):
    ...
    death_in_ed = int(data[i][545])
    icu_data = int(data[i][553:555])
    hospital_discharge_status = int(data[i][620:622])
    arrival_ambulance = int(data[i][32:34])
    length_of_visit = int(data[i][561:565])
    obs_unit_discharge = int(data[i][551])  
...
df_final.to_csv('data_2014_reasons.csv')
